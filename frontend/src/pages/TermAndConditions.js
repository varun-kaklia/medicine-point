...
const TermsAndConditions = ()=>{
    ...
    <h2 className="text-4xl text-primary underline font-bold">Terms And Conditions</h2>
    <p>
Welcome to Medicine Point!<br/>

These terms and conditions outline the rules and regulations for the use of Medicine Point's Website, located at medicinpoint.com.<br/>

By accessing this website we assume you accept these terms and conditions. Do not continue to use Medicine Point if you do not agree to take all of the terms and conditions stated on this page.<br/>
...
Cookies<br/>
We employ the use of cookies. By accessing Medicine Point, you agreed to use cookies in agreement with the Medicine Point's Privacy Policy.<br/>
...
License<br/>
Unless otherwise stated, Medicine Point and/or its licensors own the intellectual property rights for all material on Medicine Point. All intellectual property rights are reserved. You may access this from Medicine Point for your own personal use subjected to restrictions set in these terms and conditions.<br/>

You must not:<br/>

Republish material from Medicine Point<br/>
Sell, rent or sub-license material from Medicine Point<br/>
Reproduce, duplicate or copy material from Medicine Point<br/>
Redistribute content from Medicine Point<br/>
This Agreement shall begin on the date hereof.<br/>

Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Medicine Point does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Medicine Point,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Medicine Point shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.<br/>

Medicine Point reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.<br/>
...
You hereby grant Medicine Point a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.<br/>
...
We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Medicine Point; and (d) the link is in the context of general resource information.<br/>
...
If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Medicine Point. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.<br/>
...
No use of Medicine Point's logo or other artwork will be allowed for linking absent a trademark license agreement.<br/>
...
As long as the website and the information and services on the website are provided free of charge, we will not be liable for any loss or damage of any nature.<br/></p>
    </div>
}
