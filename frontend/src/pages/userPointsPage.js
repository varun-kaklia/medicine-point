...
const UserPointsPage = () => {
    ...
    if (currentUser && currentUser.points > points) {
      ...
      const oldPoints = (!currentUser.points? points:(currentUser.points + points))
      ...
      <div className='container md:grid grid-cols-12 items-start pt-4 gap-6 pb-16'>
          ...
          <div className='px-4 py-3 shadow items-center gap-4'>
            <div className='flex items-center'>
              <div>
                <img src='/images/1.png' alt='Medicine Point- Medicines wholeseller in Noida..!' className='rounded-full w-14 h-14 border border-gray-200 p-1 object-cover ' />
              </div>
            ...
            <div className='text-center py-4'>
                <h2 className='text-xl font-medium'>{ currentUser && currentUser.name} Points</h2>
            </div>
            ...
            <div className='text-center py-2'>
                ...
                <input
                    ...
                    onChange={(e) => currentUser && currentUser.points >= e.target.value ?
            ...
            <div className='text-center pb-2'>
                          <button className='border-primary rounded p-3 bg-primary text-slate-100 hover:bg-slate-50 hover:border-secondary hover:text-primary hover:transition border '
